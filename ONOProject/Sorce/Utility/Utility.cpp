...
int Utility::GetStringLength(const std::string& string, const int& fontHandle)
{
    //名前　文字列
    auto n = string.c_str();
    //文字列の文字数の取得
    ...
    //文字列の長さを取得
    int stringLen = GetDrawStringWidthToHandle(string.c_str(), len, fontHandle);
